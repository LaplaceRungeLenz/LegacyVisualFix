...
@Mod(
    modid = "legacyvisualfixstartupsmoke",
    name = "LegacyVisualFix startup smoke",
    version = "1",
...
public final class StartupSmoke {
    ...
    public void tick(TickEvent.ClientTickEvent event) throws Exception {
        ...
        File report = new File(Minecraft.getMinecraft().mcDataDir, "legacyvisualfix-startup-smoke.txt");
        try {
            ...
            for (int i = 0; i < names.length; i++) {
                ...
                maps[i].put("legacyvisualfix:startup-regression", new Object());
            }
            try {

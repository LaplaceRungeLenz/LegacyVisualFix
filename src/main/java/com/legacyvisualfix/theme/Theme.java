...
public final class Theme {
    ...
    private Theme(Properties p) {
        ...
        logo = texture(p, "texture.logo", "legacyvisualfix:textures/gui/logo.png");
        ...
        background = texture(p, "texture.background", "legacyvisualfix:textures/gui/background.png");
        track = texture(p, "texture.track", "legacyvisualfix:textures/gui/bar_track.png");
        fill = texture(p, "texture.fill", "legacyvisualfix:textures/gui/bar_fill.png");
        Fit parsed;
        try {
            parsed = Fit.valueOf(

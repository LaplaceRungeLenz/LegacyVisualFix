...
public abstract class MixinReloadableResourceManager {
    ...
    private void legacyvisualfix$reload(List<IResourcePack> packs, Operation<Void> original) {
    ...
    private void legacyvisualfix$listener(IResourceManagerReloadListener listener, IResourceManager manager,

...
@Mod(
    modid = "legacyvisualfixinventorysmoke",
    name = "LegacyVisualFix inventory smoke",
    version = "1",
...
public final class InventorySmoke {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        for (int i = 0; i < 3; i++) {
            new CreativeTabs("legacyvisualfixsmoke" + i) {
    ...
    private static final class TestScreen extends GuiScreen {
        ...
        private final File directory = new File(Minecraft.getMinecraft().mcDataDir, "legacyvisualfix-inventory-smoke");
            ...
            try {
                ...
                if (Loader.isModLoaded("NotEnoughItems")) {
                    ...
                    config.getMethod("loadWorld", String.class)
                        .invoke(null, "legacyvisualfix-inventory-smoke");
                    ...
                    Object observer = java.lang.reflect.Proxy.newProxyInstance(
                        ...
                        (proxy, method, args) -> {
                            ...
                            if (method.getName()
                                .equals("toString")) return "LegacyVisualFix smoke observer";
                            return null;
                        });
        ...
        private void finish(String result) {
            System.out.println("LEGACYVISUALFIX_INVENTORY_SMOKE " + result);
            try {

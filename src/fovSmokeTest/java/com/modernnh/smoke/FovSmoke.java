...
@Mod(modid = "modernnhfovsmoke", name = "ModernNH FOV smoke", version = "1", dependencies = "required-after:modernnh")
public final class FovSmoke {
    ...
    public void tick(TickEvent.ClientTickEvent event) throws Exception {
        ...
        File result = new File(mc.mcDataDir, "modernnh-fov-smoke.txt");
        try {

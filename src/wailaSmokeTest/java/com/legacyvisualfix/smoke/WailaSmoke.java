...
import com.legacyvisualfix.waila.TooltipAnimation;
...
@Mod(
    modid = "legacyvisualfixwailasmoke",
    name = "LegacyVisualFix Waila smoke",
    version = "1",
    dependencies = "required-after:legacyvisualfix;required-after:Waila")
public final class WailaSmoke {
    ...
    private static final class TestScreen extends GuiScreen {
        ...
        private final File results = new File(Minecraft.getMinecraft().mcDataDir, "legacyvisualfix-waila-smoke");
        ...
        private void prepare() throws Exception {
            ...
            ModuleRegistrar.instance()
                .registerTooltipRenderer("legacyvisualfix.smoke", new IWailaTooltipRenderer() {
            ...
            large = new Tooltip(
                Arrays.asList(
                    ...
                    SpecialChars.getRenderString("legacyvisualfix.smoke"),
                    "GregTech synthetic smoke data"),
                new ItemStack(Blocks.furnace));
            ((AccessorTooltip) small).legacyvisualfix$getAnchor()
                .setLocation(5000, 1000);
            ((AccessorTooltip) large).legacyvisualfix$getAnchor()
                .setLocation(5000, 1000);
            Class<?> owner = chromatic ? Class.forName("com.legacyvisualfix.waila.chromatic.ChromaticAnimation")
        ...
        private void render(Tooltip tooltip) throws Exception {
            ...
            int x = fields.legacyvisualfix$getX(), y = fields.legacyvisualfix$getY();
            int w = fields.legacyvisualfix$getWidth(), h = fields.legacyvisualfix$getHeight();
            ...
            require(
                x == fields.legacyvisualfix$getX() && y == fields.legacyvisualfix$getY()
                    && w == fields.legacyvisualfix$getWidth()
                    && h == fields.legacyvisualfix$getHeight(),
        ...
        private void finish(Throwable failure) {
            ...
            System.out.println("LEGACYVISUALFIX_WAILA_SMOKE " + text);
            mc.shutdown();
        }
    }

...
@Mod(modid = "modernnhuismoke", name = "ModernNH UI smoke", version = "1", dependencies = "required-after:modernnh")
public final class UiSmoke {
    ...
    private static class Runner extends GuiScreen {
        ...
        public void drawScreen(int x, int y, float partial) {
            ...
            File dir = new File(mc.mcDataDir, "modernnh-ui-smoke");
            String result;
            try {
                dir.mkdirs();
                ...
                System.out.println("MODERNNH_UI_GL disabledContainer=" + baselineError);
                ...
                System.out.println("MODERNNH_UI_GL enabledHover=" + hoverError);
                ...
                System.out.println("MODERNNH_UI_GL enabledCore=" + enabledError);
                ...
                if (cpw.mods.fml.common.Loader.isModLoaded("modularui")
                    ...
                    Class.forName("com.modernnh.smoke.UiMuiSmoke")
            ...
            System.out.println("MODERNNH_UI_SMOKE " + result);
            mc.shutdown();
        }
    }
    ...
    private static void renderDemo(Minecraft mc, File directory) throws Exception {
        InventoryBasic inv = new InventoryBasic("ModernNH UI effects", true, 27);
